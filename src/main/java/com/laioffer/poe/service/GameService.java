...
import com.laioffer.poe.entity.db.ItemType;
...
import com.laioffer.poe.entity.response.Game;

import java.util.*;

@Service
public class GameService {
    private static final String TOKEN = "Bearer 9xx8dodum4sy3pqxgzu0kah5enp8ya";//cg443q9h8htiorndaxoztzowptnw2p
    private static final String CLIENT_ID = "y8ngstw4wekxovkzs853k13y7zvuj4";
